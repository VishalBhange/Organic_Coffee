...
import img1 from '/public/img/sunder-pichai.jpeg';
import img2 from '/public/img/mark-zuckerberg.jpeg';
import img3 from '/public/img/adam-mosseri.jpeg';

const testimonials = [
  {
    name: "SUNDER PICHAI",
    title: "CEO at Google",
    image: img1, // Directly reference the image here
  ...
  },
  {
    ...
    image: img2, // Directly reference the image here
  ...
  },
  {
    ...
    image: img3, // Directly reference the image here
  ...
  return (
    <div className="bg-white">
      <div className="max-w-6xl mx-auto py-10 bg-white w-5/5 it">
        <button
          onClick={handlePrev}
          className="btn2 absolute mt-44 left-0 bg-brown-700 text-white p-2 rounded-full focus:outline-none"
        >
          &lt;
        </button>
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-6">
                <img
                  ...
                  className="md:w-80 h-80 object-cover im p-4 rounded-3xl mb-4"
                />
              </div>
              ...
              <div className="col-span-6 items-center content-center">
                ...
                <p className="text-sm text-gray-600 mr-48">
                  {testimonials[currentIndex].title}
                </p>
                <p className="mt-4 text-gray-700 p-4 hidden lg:block mr-32">
                  {testimonials[currentIndex].text}
                </p>
                <div className="mt-4 space-x-1 text-yellow-500 mr-48">
                  ★★★★★
                </div>
              </div>
            </div>
